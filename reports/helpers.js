module.exports = {
    ...
    TransferDayOfWeek: require('./transferDayOfWeek/helpers'),
    TransferWeekOfYear: require('./transferWeekOfYear/helpers'),
    TransferTypeStatistics: require('./transferTypeStatistics/helpers')
};
