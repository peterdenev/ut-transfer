var joi = require('joi');
module.exports = {
    description: 'maker marks batch as ready and sends it for approval to checker',
    notes: '',
    params: joi.object().keys({
        actorId: joi.string().example('4').description('the actor id of the maker'),
        batchId: joi.string().example('4')
    }),
