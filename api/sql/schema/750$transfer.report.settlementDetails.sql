...
BEGIN TRY
    ...
    (
        SELECT
            ...
            CASE WHEN v.channelType = N'iso' THEN v.transferIdAcquirer ELSE CAST(v.transferId AS NVARCHAR(50)) END AS transferIdAcquirer, --[Serial],
            ...
            CASE WHEN v.channelType = N'iso' THEN v.transferIdIssuer ELSE CAST(v.transferId AS NVARCHAR(50)) END AS transferIdIssuer, -- authorisationCode
